...
public interface ConfigurationValidator {
    ...
    /// Utils
    static void validateOptionalBooleanProperty(Properties config, String key, String message) {
    ...
    static void validateOptionalPositiveIntProperty(Properties config, String key, String message) {
        if (config.containsKey(key)) {
            try {
    ...
    static void validateOptionalPositiveDoubleProperty(
            Properties config, String key, String message) {
        if (config.containsKey(key)) {
            try {
    ...
    static void validateOptionalDateProperty(
