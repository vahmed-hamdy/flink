...
import org.apache.flink.table.connector.sink.AsyncDynamicTableSink;
import org.apache.flink.table.connector.sink.AsyncDynamicTableSinkBuilder;
...
public class KinesisDynamicSink extends AsyncDynamicTableSink<PutRecordsRequestEntry>
    ...
    public void applyStaticPartition(Map<String, String> partition) {
        if (partitioner instanceof RowDataFieldsKinesisKeyGenerator) {
            ((RowDataFieldsKinesisKeyGenerator) partitioner).setStaticFields(partition);
        } else {
            String msg =
                    ""
