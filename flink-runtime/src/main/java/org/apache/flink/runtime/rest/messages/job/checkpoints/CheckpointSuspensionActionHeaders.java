...
public class CheckpointSuspensionActionHeaders
        extends AsynchronousOperationTriggerMessageHeaders<
                CheckpointSuspensionRequest, JobMessageParameters> {

    private static final CheckpointSuspensionActionHeaders INSTANCE =
            new CheckpointSuspensionActionHeaders();

    private static final String URL =
            String.format("/jobs/:%s/checkpointing", JobIDPathParameter.KEY);

    private CheckpointSuspensionActionHeaders() {}

    @Override
    public Class<CheckpointSuspensionRequest> getRequestClass() {
        return CheckpointSuspensionRequest.class;
    }
    ...
    public static CheckpointSuspensionActionHeaders getInstance() {
        return INSTANCE;
    }

    @Override
    protected String getAsyncOperationDescription() {
        return "Suspends/Resumes checkpointing on the jobmanager";
    }
}
